% Demo to find certain shapes in an image based on their shape (circularities) and number of vertices, and compares the two methods.
...
% 	set(gcf, 'Toolbar', 'none', 'Menu', 'none');
	...
	%-------------------------------------------------------------------------------------------------------------------
	% Now compute the number of vertices by looking at the circularities.
...
try
	...
	for k = 1 : numRegions
		...
		if promptUser % Let user see the curves.
			...
			grid on;
			message = sprintf('Centroid to perimeter distances for shape #%d of %d', k, numRegions);
		...
		if promptUser % Let user see the curves.
			...
			message = sprintf('Centroid to perimeter distances for shape #%d of %d.  Found %d peaks.', k, numRegions, numVertices(k));
